#
#  Be sure to run `pod spec lint libffi.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.description  = <<-DESC
                      A portable foreign-function interface library for iOS.
                   DESC
  ...
  spec.xcconfig = {'GCC_PREPROCESSOR_DEFINITIONS' => '$(inherited) USE_DL_PREFIX=1', 'GCC_WARN_INHIBIT_ALL_WARNINGS' => 'YES'}
end
